...
class LinkEditor extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Flex_1.default, { className: "rme-LinkEditor-Wrapper" },
            ...
            React.createElement(ToolbarButton_1.default, { onClick: this.handleOpenLink, disabled: !value },
                React.createElement(Tooltip, { tooltip: dictionary.openLink, placement: "top" },
                    React.createElement(outline_icons_1.OpenIcon, { color: "var(--color-background-2)" }))),
            React.createElement(ToolbarButton_1.default, { onClick: this.handleRemoveLink },
                React.createElement(Tooltip, { tooltip: dictionary.removeLink, placement: "top" }, this.initialValue ? (React.createElement(outline_icons_1.TrashIcon, { color: "var(--color-background-2)" })) : (React.createElement(outline_icons_1.CloseIcon, { color: "var(--color-background-2)" })))),
            showResults && (React.createElement("ol", { id: "link-search-results", className: "rme-LinkEditor-Wrapper-SearchResults" },
                results.map((result, index) => (React.createElement(LinkSearchResult_1.default, { key: result.url, title: result.title, subtitle: result.subtitle, icon: React.createElement(outline_icons_1.DocumentIcon, { color: "var(--color-background-2)" }), onMouseOver: () => this.handleFocusLink(index), onClick: this.handleSelectLink(result.url, result.title), selected: index === selectedIndex }))),
                showCreateLink && (React.createElement(LinkSearchResult_1.default, { key: "create", title: suggestedLinkTitle, subtitle: dictionary.createNewDoc, icon: React.createElement(outline_icons_1.PlusIcon, { color: "var(--color-background-2)" }), onMouseOver: () => this.handleFocusLink(results.length), onClick: () => {
